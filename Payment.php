...
<!--Patient ka table check karny ky liya dala tha-->
 ...
 <form class="form-container"  onSubmit="return validation()" class="bg-light" style=" margin-top:25px">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <label for="appointmentdatetime" class="coachform"><b>Appointment Date and Time</b></label>
                     <input type="datetime-local" id="appointmentdatetime" name="appointmentdatetime" placeholder="" class="form-control">
